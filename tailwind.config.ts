  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        electric:  "0 0 10px rgba(0,204,255,0.5), 0 0 40px rgba(0,204,255,0.18)",
        cyber:     "0 0 10px rgba(124,58,237,0.5), 0 0 40px rgba(124,58,237,0.18)",
      ...
      backgroundImage: {
        ...
        "neon-gradient":  "linear-gradient(135deg, #00ff88, #00ccff)",
        "gold-gradient":  "linear-gradient(135deg, #ffd700, #ff8c00)",
        "cyber-gradient": "linear-gradient(135deg, #7c3aed, #00ccff)",
      },
    },
  },
  plugins: [],
