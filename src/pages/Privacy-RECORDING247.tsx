...
export function Privacy() {
  return (
    <div className="prose prose-invert max-w-3xl">
      ...
      <h2 className="font-display text-2xl font-bold text-white">Your advertising choice</h2>
      <p className="text-muted">
        When advertising is configured, you can allow or decline advertising cookies using the privacy choice banner. Declining prevents this site from loading its advertising script in your browser. Some regions may require additional consent controls before personalized advertising can be served.
      </p>
